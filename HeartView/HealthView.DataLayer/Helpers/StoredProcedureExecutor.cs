...
//namespace HealthView.DataLayer.Helpers
//{
//    /// <summary>
//    ///     Executes a batch of stored procedures as a transaction against the SQL server
//    /// </summary>
//    /// <param name="storedProcedures"></param>
//    public bool ExecuteNoQueryAsTransaction(IEnumerable<StoredProcedureBase> storedProcedures)
//    {
//        var result = true;
...
//    private DataTable ExecuteStoredProcedure(StoredProcedureBase sp, out OperationStatus or)
//    {
...
//        try
//        {
//            RetryPolicy<CustomTransientErrorDetectionStrategy> retryPolicy =
//                TransientFaultHelper.GetRetryPolicy();
...
//    private OperationStatus ExtractStatusOutputParameters(SqlCommand cmd)
//    {
...
//    private void AddStatusOutputParameters(SqlCommand cmd)
//    {
//        if (cmd == null)
//        {
//            return;
...
//    public T GetSingleSetResult<T>(StoredProcedureBase sProc, out OperationStatus or) where T : class, new()
//    {
...
//    public List<T> GetMultipleSetResult<T>(StoredProcedureBase sProc, out OperationStatus or) where T : class, new()
//    {
//        List<T> result = null;
//        or = null;
//        if (sProc != null)
...
//    private SqlParameter[] SetSqlParameters(Dictionary<string, object> parameters)
//    {
